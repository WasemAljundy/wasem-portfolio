...
- [x] Private GitHub remote created and `main` upstream configured.
...
- [x] Vercel account authentication restored.
- [x] Protected preview deployment created, inspected, and validated.
- [x] Validated preview promoted to the production alias.
...
- [x] Deployed canonical, Open Graph, Twitter, sitemap, and robots output verified.
- [x] Public homepage/Jood social images inspected from their deployed URLs.
...
- [x] Deployed route, responsive, accessibility, and performance QA completed at 375, 768, 1024, and 1440px.
- [x] Production synthetic Jood medians recorded: LCP 800 ms mobile / 1,292 ms desktop; CLS 0.0017 / 0.0008.
- [x] External destinations rechecked from the deployed website; Apple throttled one repeated probe while the page remained independently reachable.
...
- [x] Final production smoke test, cache check, and first-hour error/500 scan complete.
